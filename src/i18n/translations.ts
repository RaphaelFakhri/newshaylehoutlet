...
export const ui = {
  en: {
    ...
    'product.message': "Hello, I'm interested in",
  ...
  ar: {
    ...
    'hero.subtitle': 'تفضّلوا بزيارة محلّنا في نيو شايلة — اطلبوا أي قطعة مباشرة عبر واتساب.',
    'hero.cta': 'تصفّح المجموعة',
    'hero.whatsapp': 'تواصل عبر واتساب',
    'shop.title': 'المجموعة',
    'shop.empty': 'وصلات جديدة قريباً.',
    'product.order': 'اطلب عبر واتساب',
    'product.message': 'مرحبًا، أنا مهتم بـ',
